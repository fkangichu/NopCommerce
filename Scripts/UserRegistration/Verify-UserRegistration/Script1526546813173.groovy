...
WebUiBuiltInKeywords.click(findTestObject('RegisterPage/Button_Register'))

WebUI.verifyElementPresent(findTestObject('RegistrationSuccessfulPage/Message_RegistrationSuccessful'), 2)

WebUiBuiltInKeywords.click(findTestObject('RegistrationSuccessfulPage/Button_Continue'))
